...
const std::string Gui::BUTTON_TEMPLE = "MainTabControl/Rooms/RoomsSP/TempleButton";
const std::string Gui::BUTTON_PORTAL = "MainTabControl/Rooms/RoomsSP/PortalButton";
const std::string Gui::BUTTON_DESTROY_ROOM = "MainTabControl/Rooms/RoomsSP/DestroyRoomButton";
