...
class RoomDormitoryFactory : public RoomFactory
{
    ...
    {
        Room::checkBuildRoomDefault(gameMap, RoomDormitory::mRoomType, inputManager, inputCommand);
    }
    ...
    {
        Room::checkBuildRoomDefaultEditor(gameMap, RoomDormitory::mRoomType, inputManager, inputCommand);
    }
