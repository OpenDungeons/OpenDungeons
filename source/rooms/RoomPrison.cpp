...
class RoomPrisonFactory : public RoomFactory
{
    ...
    {
        Room::checkBuildRoomDefault(gameMap, RoomPrison::mRoomType, inputManager, inputCommand);
    }
    ...
    {
        Room::checkBuildRoomDefaultEditor(gameMap, RoomPrison::mRoomType, inputManager, inputCommand);
    }
