...
#ifndef RENDERSCENESYNCPOST_H
#define RENDERSCENESYNCPOST_H

#include "renderscene/RenderScene.h"

class RenderSceneSyncPost : public RenderScene
{
public:
    RenderSceneSyncPost()
    {}

    virtual ~RenderSceneSyncPost()
    {}
