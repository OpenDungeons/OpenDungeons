...
#ifndef RENDERSCENECAMERAMOVE_H
#define RENDERSCENECAMERAMOVE_H

#include "renderscene/RenderScene.h"

class RenderSceneCameraMove : public RenderScene
{
public:
    RenderSceneCameraMove()
    {}

    virtual ~RenderSceneCameraMove()
    {}
