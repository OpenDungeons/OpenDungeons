...
public:
    ...
    inline void print(String_t string)
    {
        ...
        //mHistoryBuffer.emplace_front(string);
    }
    ...
    void addCommand(String_t name, String_t description, CommandFunction_t command,
    ...
    Command::Result tryExecuteCommand(String_t commandString, ModeType modeType, ModeManagerInterface* modeManager);
    ...
    boost::optional<String_t> tryCompleteCommand(const String_t& prefix);
...
private:
    ...
    static Command::Result helpCommand(const Command::ArgumentList_t& args, ConsoleInterface& console, ModeManagerInterface*);
    ...
    using CommandMap_t = std::unordered_map<String_t,CommandPtr_t>;
    ...
    //std::forward_list<String_t> mHistoryBuffer;
};
