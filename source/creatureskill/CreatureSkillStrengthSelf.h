...
#ifndef CREATURESKILLSTRENGTHSELF_H
#define CREATURESKILLSTRENGTHSELF_H
...
class CreatureSkillStrengthSelf : public CreatureSkill
{
public:
    // Constructors
    CreatureSkillStrengthSelf() :
        mCreatureLevelMin(0),
        mEffectDuration(0),
        mEffectValue(0.0)
    {}

    virtual ~CreatureSkillStrengthSelf()
    {}
    ...
    virtual CreatureSkillStrengthSelf* clone() const override;
...
#endif // CREATURESKILLSTRENGTHSELF_H
