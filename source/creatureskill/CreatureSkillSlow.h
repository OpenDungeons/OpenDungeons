...
#ifndef CREATURESKILLSLOW_H
#define CREATURESKILLSLOW_H
...
class CreatureSkillSlow : public CreatureSkill
{
public:
    // Constructors
    CreatureSkillSlow() :
    ...
    virtual CreatureSkillSlow* clone() const override;
